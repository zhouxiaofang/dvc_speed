...
class Output:
    ...
    def __init__(
        ...
        t = datetime.now()
        self.time_build  = t - t
        self.time_otransfer = t - t
        self.time_checkout = t - t
        self.time_set_exec = t - t
    ...
    def _checkout(self, *args, **kwargs):
        ...
        try:
            return checkout(*args, **kwargs) #checkout大操作 核心耗时函数，log by zhoufang 20221206
    ...
    def commit(self, filter_info=None):
        ...
        if self.use_cache:
            ...
            if granular:
                ...
                t2 = datetime.now()
                self.time_build += (t2-t1)
                print("success finished memory build(), self.time_build={}".format(self.time_build))
            ...
            # )
            # t2 = datetime.now()
            # self.time_checkout += (t2-t1)
            # print("success finished _checkout(), self.time_checkout={}". format(self.time_checkout))
    ...
    def checkout(
        ...
        **kwargs,
        ...
        t2 = datetime.now()
        time_step0_1 = t2-t1
        print("success call in self.checkout() step[0~1], [get objs操作时间] @{}".format(time_step0_1))
        try:
            t3 = datetime.now()
            ...
            t4 = datetime.now()
            time_checkout = t4-t3
            print("success finished _checkout() step[1~3], total_time_checkout={}". format(time_checkout))
